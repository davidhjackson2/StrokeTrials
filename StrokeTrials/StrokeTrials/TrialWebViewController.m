...
- (IBAction)share:(id)sender
{
    ...
    NSString *messageBody = [NSString stringWithFormat:@"<html><body><br\\>Check out this article I found using the free <a href=''>Stroke Trials</a> iOS app.</br></br><a href='%@'>%@</br></a><b>%@</b></br><i>%@</i></br>%@</body></html>", self.link, self.acro, self.title, self.journal, self.yearValue];
